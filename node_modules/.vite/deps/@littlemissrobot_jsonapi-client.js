...
// node_modules/@littlemissrobot/jsonapi-client/dist/index.js
...
var _Model = class _Model2 {
  ...
  serialize() {
    ...
    for (const key of Object.keys(this)) {
      ...
      if (value instanceof _Model2) {
        data[key] = value.serialize();
      } else if (Array.isArray(value)) {
        data[key] = value.map(
          (v) => v instanceof _Model2 ? v.serialize() : v
        );
      } else {
        data[key] = value;
      }
...
//# sourceMappingURL=@littlemissrobot_jsonapi-client.js.map
